...
stow /home/chuck/workspace/personal/dotfiles/gentoo-server-hetzner-proxy/portage /etc/portage
# stow /home/chuck/workspace/personal/dotfiles/gentoo-server-hetzner-proxy/unprivileged-port-start.conf /etc/sysctl.d/unprivileged-port-start.conf
#!!! stow /home/chuck/workspace/personal/dotfiles/gentoo-server-hetzner-proxy/ip_tables.conf /etc/modules-load.d/ip_tables.conf
...
stow /home/chuck/workspace/personal/dotfiles/gentoo-server-hetzner-proxy/haproxy.cfg /etc/haproxy/haproxy.cfg
...
ustow /home/chuck/workspace/personal/dotfiles/gentoo-server-hetzner-proxy/authorized_keys /home/chuck/.ssh/authorized_keys
...
sed --in-place 's/#GatewayPorts no/GatewayPorts yes/g' /etc/ssh/sshd_config
...
#rc-update add haproxy default >/dev/null 2>&1
...
run_as_user chuck secrets-bootstrap
run_as_user chuck secrets-set cert-remote-4620-duckdns
stow /home/chuck/.ssh/secrets/cert-remote-4620-duckdns/remote-4620.duckdns.org.pem /etc/haproxy/certs/remote-4620.duckdns.org.pem
