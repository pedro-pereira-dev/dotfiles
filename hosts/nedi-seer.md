...
# sets up seer
mkdir -p /opt/podman/seer
chmod -R 777 /opt/podman/seer
...
# Seer
ufw allow in on eth0 from 10.0.0.0/8 to any port 5055 proto tcp
ufw allow in on eth0 from 172.16.0.0/12 to any port 5055 proto tcp
ufw allow in on eth0 from 192.168.0.0/16 to any port 5055 proto tcp
ufw enable
