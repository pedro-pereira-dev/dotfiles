...
dots_sync() {
  ...
  stow "$DOTFILES_WORKSPACE/hosts/bra-m0234.d/tmp/temp1" "$HOME/.config/tmp-dotfiles/temp1"
  stow "$DOTFILES_WORKSPACE/hosts/bra-m0234.d/tmp/temp3" "$HOME/.tmp-dotfiles-moved/nested/temp3"
  stow "$DOTFILES_WORKSPACE/hosts/bra-m0234.d/tmp/temp5" "$HOME/.tmp-dotfiles/temp5"
