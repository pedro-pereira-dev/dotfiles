...
```
lsblk -o NAME,FSTYPE,UUID,SIZE,FSAVAIL,MOUNTPOINTS
```
...
UUID=71d17bfa-3a82-4c54-a9cb-fa1824ee509d   none        swap    sw 0 0
UUID=e75056ad-832a-4640-be04-fe5c4ea0c093   /           ext4    defaults,errors=remount-ro 0 1
$()
UUID=65cbfc87-db41-49d5-9393-e282c0abf027   /mnt/baks   ext4    defaults 0 0
UUID=d70ba9a4-1dc1-495b-a13b-8a661ae5af1e   /mnt/imgs   ext4    defaults 0 0
EOF
...
(crontab -l 2>/dev/null; echo "0 2 * * * backup-host-to pbs") | crontab -
...
# installs utilities
apt install -y btop htop powertop
